...
const shazamCountry = ['DE', 'PT', 'DK', 'HR', 'UA', 'HU', 'MA', 'ID', 'IE', 'US', 'EG', 'IL',
  'UY', 'IN', 'ZA', 'IT', 'MX', 'MY', 'ES', 'VE', 'AR', 'AT', 'AU', 'RO',
  'NL', 'NO', 'RU', 'BE', 'FI', 'BG', 'JP', 'FR', 'NZ', 'SA', 'BR', 'SE', 'SG', 'BY', 'GB', 'CA', 'CH', 'KR', 'CL', 'GR', 'CN', 'CO', 'KZ', 'CR', 'TH', 'PE', 'CZ', 'PL', 'TR'];
...
const getMatch = (a, b) => {
  for (let i = 0; i < a.length; i += 1) {
    for (let e = 0; e < b.length; e += 1) {
      if (a[i].code === b[e]) shazamList.push(a[i]);
    }
  }
  return shazamList;
};
